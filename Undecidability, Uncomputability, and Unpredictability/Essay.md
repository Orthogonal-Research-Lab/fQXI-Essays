...
[8] Fishwick, P. (2017). Modeling as the Practice of Representation. In _Proceedings of the 2017 Winter Simulation Conference_, W.K.V. Chan, A. D'Ambrogio, G. Zacharewicz, N. Mustafee, G. Wainer, and E. Page, eds., pgs. 4276-4287.

[9] Jaynes, J. (2000). The Origin of Consciousness in the Breakdown of the Bicameral Mind. Mariner Books.

[10] Brown, V.A., Harris, J.A., and Russell, J.Y. (2010). Tackling Wicked Problems: Through the Transdisciplinary Imagination. Earthscan, London. Term originated by C. West Churchman.

[11] Forrester, J.W. (1969). Urban Dynamics. Pegasus Books, New York.

[12] Kempinska, K. (2019). Machine learning for modelling urban dynamics. Doctoral thesis, University College London. 

[13] Gordon, R. (2020). The whimsical history of proposed motors for diatom motility. In: Diatom
...
[14] Yanofsky, N.S. (2013). Outer Limits of Reason: what science, mathematics, and logic cannot tell us. MIT Press, Cambridge MA. 

[15] Ab Wahab, M.N., Nefti-Meziani, S., and Atyabi, A. (2015). A Comprehensive Review of Swarm Optimization Algorithms. _PLoS One_, 10(5), e0122827.

[16] Van der Gucht, J. (2018). Grand Challenges in Soft Matter Physics. _Frontiers in Physics_, doi:10.3389/fphy.2018.00087.

[17] Rokne, J.G. (2001). Interval Arithmetic and Interval Analysis: An Introduction. In "Granular Computing", W. Pedrycz ed., pp. 1-22. Springer, Berlin. 

[18] Rose, G.J., Leary, C.J., and Edwards, C.J. (2011). Interval-counting Neurons in the Anuran Auditory Midbrain: Factors Underlying Diversity of Interval Tuning. _Journal of Computation and Physiology A_, 197(1), 97-108.

[19] Mel, B.W. (1994). Information Processing in Dendritic Trees. _Neural Computation_, 6(6), 1031-1085. doi:10.1162/neco.1994.6.6.1031.

[20] Khasanova, R. and Frossard, P. (2019). Isometric Transformation Invariant Graph-based Deep Neural Network. _arXiv_, 1808.07366.

[21] Soejima, T., Siva, K., Bultinck, N., Chatterjee, S., Pollmann, F., and Zaletel, M.F. (2020). Isometric tensor network representation of string-net liquids. _Physical Review B_, 101, 085117.

[22] Hofstadter, D. (2007). I Am A Strange Loop. Basic Books, New York.

[23] Xu, W., Ma, J., Wang, S., and Hao, G. (2010). Vague soft sets and their properties. _Computers & Mathematics with Applications_, 59(2), 787-794.

[24] Palm, G. (2013). Neural associative memories and sparse coding. _Neural Networks_, 37, 165-171.

[25] Castillo, O. and Melin, P. (2014). A review on interval type-2 fuzzy logic applications in intelligent control. _Information Sciences_, 279, 615-631.
